            ...
            {enderecos.map((endereco, index) => (
                <div
                    ...
                    <div className="flex items-center gap-3 sm:gap-4">
                        <IoMdRadioButtonOn className={toggle === index ? 'text-2xl sm:text-3xl text-emerald-600' : 'hidden'} />
                        <IoMdRadioButtonOff className={toggle !== index ? 'text-2xl sm:text-3xl' : 'hidden'} />
